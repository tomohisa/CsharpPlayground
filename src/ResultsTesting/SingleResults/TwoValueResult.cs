    ...
    Exception? Exception)
{
    ...
    public SingleResult<TValue3> Railway<TValue3>(
        Func<TValue1, TValue2, SingleResult<TValue3>> handleValueFunc) => this
        switch
        {
    ...
    {
        { Exception: not null } e => new ThreeValueResult<TValue1, TValue2, TValue3>(
            Value1,
            Value2,
            default,
            e.Exception),
        { Value1: not null, Value2: not null } => thirdValue switch
        {
            { Exception: not null } e => new ThreeValueResult<TValue1, TValue2, TValue3>(
                ...
                default,
                e.Exception),
            { Value: not null } => new ThreeValueResult<TValue1, TValue2, TValue3>(
                Value1,
                Value2,
                thirdValue.Value,
                null),
            _ => new ThreeValueResult<TValue1, TValue2, TValue3>(Value1, Value2, default, null)
        },
        _ => new ThreeValueResult<TValue1, TValue2, TValue3>(
            Value1,
            Value2,
            default,
    ...
    public ThreeValueResult<TValue1, TValue2, TValue3> CombineValue<TValue3>(
        Func<TValue1, TValue2, SingleResult<TValue3>> thirdValueFunc) => this switch
    {
        { Exception: not null } e => new ThreeValueResult<TValue1, TValue2, TValue3>(
            Value1,
            Value2,
        ...
        { Value1: { } value1, Value2: { } value2 } => thirdValueFunc(value1, value2) switch
        {
            { Exception: not null } e => new ThreeValueResult<TValue1, TValue2, TValue3>(
                ...
                default,
                e.Exception),
            { Value: { } value3 } => new ThreeValueResult<TValue1, TValue2, TValue3>(
                Value1,
                Value2,
                value3,
                null),
