    ...
    Exception? Exception)
{
    ...
    public TValue4 GetValue4() => (IsSuccess ? Value4 : throw new InvalidOperationException("no value")) ?? throw new InvalidOperationException();
    public TValue5 GetValue5() => (IsSuccess ? Value5 : throw new InvalidOperationException("no value")) ?? throw new InvalidOperationException();

    public SingleResult<TValue6> Railway<TValue6>(Func<TValue1, TValue2, TValue3, TValue4, TValue5, SingleResult<TValue6>> handleValueFunc) => this
        switch
        {
            { Exception: not null } e => e.Exception,
            { Value1: { } value1, Value2: { } value2, Value3: { } value3, Value4: { } value4, Value5: { } value5 } => handleValueFunc(value1, value2, value3, value4, value5),
